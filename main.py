...
from features.utils.data_cleaning import data_clean_csv, data_clean_excel
...
file_csv = st.sidebar.file_uploader("Upload CSV")
file_excel = st.sidebar.file_uploader("Upload Excel")

if file_csv:
    df, cols = data_clean_csv(file_csv)   
...
if file_excel:
    df, cols = data_clean_excel(file_excel)   
